...
class CustomBottomNavigationBar extends GetView<PageIndexController> {
  ...
  Widget build(BuildContext context) {
    return Container(
      height: Platform.isAndroid ? 134 : 97,
      ...
      child: Stack(
        ...
        children: [
          Positioned(
            bottom: 0,
            child: Container(
              height: Platform.isAndroid ? 96 : 65,
              width: MediaQuery.of(context).size.width,
          ...
          Positioned(
            bottom: Platform.isAndroid? 64 : 32,
            child: Obx(
                  () => SizedBox(
                width: Platform.isAndroid? 70 : 64,
                height: Platform.isAndroid ? 70 : 64,
